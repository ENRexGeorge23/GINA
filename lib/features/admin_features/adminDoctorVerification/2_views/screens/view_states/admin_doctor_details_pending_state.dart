...
import 'package:first_app/features/admin_features/adminDoctorVerification/2_views/widgets/declined_verification_dialog.dart';
                  ...
                  Column(
                    ...
                    children: [
                            ...
                            children: [
                              OutlinedButton.icon(
                                  ...
                                  foregroundColor:
                                    ...
                                    (Set<MaterialState> states) {
                                      if (states
                                        ...
                                        return Colors
                                            .white; // The color when the button is hovered
                                      }
                                  ...
                                  overlayColor:
                                    ...
                                    (Set<MaterialState> states) {
                                      if (states
                                          .contains(MaterialState.hovered)) {
                                        return Colors
                                            .green; // The color when the button is hovered
                                      }
                                ...
                                onPressed: () {
                                  if (isFromAdminDashboard) {
                                    adminDashboardBloc
                                        .add(AdminDashboardApproveEvent(
                                  ...
                                  overlayColor:
                                    ...
                                    (Set<MaterialState> states) {
                                      if (states
                                          .contains(MaterialState.hovered)) {
                                        return Colors
                                            .red; // The color when the button is hovered
                                      }
                      ...
                      Container(
                        ...
                        child: Center(
                          child: Text(pendingDoctorDetails.medicalSpecialty,
                              style: Theme.of(context)
                                  .textTheme
                                  .bodySmall
                                  ?.copyWith(
                            ...
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  const Gap(7),
                                  Text(
                                    pendingDoctorDetails.officePhoneNumber,
                                    style: themeOfContext.textTheme.labelMedium
                                        ?.copyWith(
                                      color: GinaAppTheme.lightSecondary,
                                      fontWeight: FontWeight.w600,
                                  ...
                                  const Gap(7),
                                  Text(
                                    pendingDoctorDetails.officeAdress,
                                    style: themeOfContext.textTheme.labelMedium
                                        ?.copyWith(
                                      color: GinaAppTheme.lightOnSecondary,
                                      fontWeight: FontWeight.w800,
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              const Gap(24),
                              Text(
                                pendingDoctorDetails.boardCertificationDate,
                                style: themeOfContext.textTheme.labelMedium
                                    ?.copyWith(
                                  color: GinaAppTheme.lightOnSecondary,
                                  fontWeight: FontWeight.w800,
                      ...
                      Row(
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              Text(
                                pendingDoctorDetails.medicalSchool,
                                style: themeOfContext.textTheme.labelMedium
                                    ?.copyWith(
                                  color: GinaAppTheme.lightOnSecondary,
                                  fontWeight: FontWeight.w800,
                              ...
                              const Gap(24),
                              Text(
                                pendingDoctorDetails.medicalSchoolStartDate,
                                style: themeOfContext.textTheme.labelMedium
                                    ?.copyWith(
                                  color: GinaAppTheme.lightOnSecondary,
                                  fontWeight: FontWeight.w800,
                              ...
                              const Gap(10),
                              Text(
                                pendingDoctorDetails.medicalSchoolEndDate,
                                style: themeOfContext.textTheme.labelMedium
                                    ?.copyWith(
                                  color: GinaAppTheme.lightOnSecondary,
                                  fontWeight: FontWeight.w800,
                      ...
                      Row(
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              Text(
                                pendingDoctorDetails.residencyProgram,
                                style: themeOfContext.textTheme.labelMedium
                                    ?.copyWith(
                                  color: GinaAppTheme.lightOnSecondary,
                                  fontWeight: FontWeight.w800,
                              ...
                              const Gap(24),
                              Text(
                                pendingDoctorDetails.residencyProgramStartDate,
                                style: themeOfContext.textTheme.labelMedium
                                    ?.copyWith(
                                  color: GinaAppTheme.lightOnSecondary,
                                  fontWeight: FontWeight.w800,
                      ...
                      Row(
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              Text(
                                pendingDoctorDetails.fellowShipProgram,
                                style: themeOfContext.textTheme.labelMedium
                                    ?.copyWith(
                                  color: GinaAppTheme.lightOnSecondary,
                                  fontWeight: FontWeight.w800,
                              ...
                              const Gap(24),
                              Text(
                                pendingDoctorDetails.fellowShipProgramStartDate,
                                style: themeOfContext.textTheme.labelMedium
                                    ?.copyWith(
                                  color: GinaAppTheme.lightOnSecondary,
                                  fontWeight: FontWeight.w800,
                              ...
                              const Gap(10),
                              Text(
                                pendingDoctorDetails.fellowShipProgramEndDate,
                                style: themeOfContext.textTheme.labelMedium
                                    ?.copyWith(
                                  color: GinaAppTheme.lightOnSecondary,
                                  fontWeight: FontWeight.w800,
