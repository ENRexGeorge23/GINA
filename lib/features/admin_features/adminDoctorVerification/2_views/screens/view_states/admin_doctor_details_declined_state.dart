...
import 'package:first_app/features/admin_features/adminDoctorVerification/2_views/widgets/declined_verification_information_dialog.dart';
                  ...
                  Column(
                    ...
                    children: [
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              Text(
                                declinedDoctorDetails.officeMapsLocationAddress,
                                style: Theme.of(context)
                                    .textTheme
                                    .labelMedium
                                    ?.copyWith(
                      ...
                      Container(
                        ...
                        child: Center(
                          child: Text(declinedDoctorDetails.medicalSpecialty,
                              style: Theme.of(context)
                                  .textTheme
                                  .bodySmall
                                  ?.copyWith(
                          ...
                          Row(
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  Text(
                                    declinedDoctorDetails.medicalLicenseNumber,
                                    style: themeOfContext.textTheme.labelMedium
                                        ?.copyWith(
                                  ...
                                  const Gap(7),
                                  Text(
                                    declinedDoctorDetails.officeLatLngAddress,
                                    style: themeOfContext.textTheme.labelMedium
                                        ?.copyWith(
                                      color: GinaAppTheme.lightOnSecondary,
                                      fontWeight: FontWeight.w800,
                            ...
                            InkWell(
                              onTap: () {
                                if (verification.verificationStatus ==
                                  ...
                                  declinedVerificationInformationDialog(context,
