          ...
          Align(
            ...
            child: Column(
              ...
              children: [
                ...
                const Gap(10),
                styledFormField(context, 'Name of the medical school attended',
                    medicalSchoolController, false),
                const Gap(10),
                styledFormField(
                  context,
                  'Start date',
                  ...
                  onTap: () => authBloc.selectDate(
                      context, medicalSchoolStartDateController),
                  readOnly: true,
                ),
                const Gap(10),
                styledFormField(
                    context, 'End Date', medicalSchoolEndDateController, false,
                    icon: Icons.calendar_today,
                    onTap: () => authBloc.selectDate(
                        context, medicalSchoolEndDateController),
                    readOnly: true),
                const Gap(10),
                const Text(
                  'Residency Program',
                ...
                const Gap(10),
                styledFormField(context, 'Name of the residency program',
                    residencyProgramController, false),
                const Gap(10),
                styledFormField(context, 'Start date',
                    residencyProgramStartDateController, false,
                    icon: Icons.calendar_today,
                    onTap: () => authBloc.selectDate(
                        context, residencyProgramStartDateController),
                    readOnly: true),
                const Gap(10),
                styledFormField(context, 'End Date',
                    residencyProgramGraduationYearController, false,
                    icon: Icons.calendar_today,
                    onTap: () => authBloc.selectDate(
                        context, residencyProgramGraduationYearController),
                    readOnly: true),
              ],
            ),
          ),
