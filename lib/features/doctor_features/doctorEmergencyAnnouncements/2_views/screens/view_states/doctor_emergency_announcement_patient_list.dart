...
class DoctorEmergencyPatientList extends StatelessWidget {
  final Map<DateTime, List<AppointmentModel>> approvedPatients;
  const DoctorEmergencyPatientList({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        final requestsOnDate = approvedPatients[date]!;
        return Column(
