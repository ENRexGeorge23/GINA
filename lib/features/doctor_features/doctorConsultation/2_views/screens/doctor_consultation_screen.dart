...
import 'package:first_app/features/doctor_features/doctorConsultation/2_views/screens/view_states/doctor_consultation_on_going_appointment_screen.dart';
import 'package:first_app/features/doctor_features/doctorConsultation/2_views/screens/view_states/patient_data_details_state.dart';
import 'package:first_app/features/doctor_features/doctorConsultation/2_views/widgets/doctor_consultation_menu.dart';
            ...
            builder: (context, state) {
              if (state is DoctorConsultationNoAppointmentState) {
                ...
                return DoctorConsultationOnGoingAppointmentScreen(
                    patientUid: patientUid, chatroom: chatRoom);
