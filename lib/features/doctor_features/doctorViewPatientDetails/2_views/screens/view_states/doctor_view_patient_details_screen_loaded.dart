...
class DoctorViewPatientDetailsScreenLoaded extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final filterPatientAppointments = patientAppointments
        .where((appointment) =>
            appointment.appointmentStatus == AppointmentStatus.completed.index)
        .toList();

    final patientAppointmentDetail = patientAppointments.firstWhere(
        (appointment) =>
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: patientAppointmentDetail.appointmentUid == null
                  ? Center(
                      child: Text(
                        "No upcoming appointment data available",
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            const Gap(3),
                            Text(
                                patientAppointmentDetail.appointmentUid
                                    .toString(),
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            const Gap(3),
                            Text(
                                patientAppointmentDetail.appointmentDate
                                    .toString(),
                                style: Theme.of(context).textTheme.bodySmall),
                          ],
                        ),
                        Row(
                          ...
                          children: [
                            ...
                            const Gap(3),
                            Text(
                                patientAppointmentDetail.appointmentTime
                                    .toString(),
                                style: Theme.of(context).textTheme.bodySmall),
                          ],
                        ),
                        Row(
                          ...
                          children: [
                            ...
                            const Gap(3),
                            Text(
                                patientAppointmentDetail.modeOfAppointment == 0
                                    ? 'Online Consultation'
            ...
            const Gap(10),
            filterPatientAppointments.isEmpty
                ? Center(
                    child: Text(
                ...
                : SizedBox(
                    ...
                    child: ListView.builder(
                      itemCount: filterPatientAppointments.length,
                      itemBuilder: (context, index) {
                        final patientAppointment =
                            filterPatientAppointments[index];
