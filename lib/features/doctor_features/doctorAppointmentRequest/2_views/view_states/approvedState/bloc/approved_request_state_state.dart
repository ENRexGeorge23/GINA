...
class ApprovedRequestActionState extends ApprovedRequestStateState {
...
class GetApprovedRequestFailedState extends ApprovedRequestStateState {
  ...
  const GetApprovedRequestFailedState({required this.message});
...
class NavigateToPatientDataState extends ApprovedRequestActionState {
  ...
  @override
  List<Object> get props =>
      [patientData, appointment, patientPeriods, patientAppointments];
}
