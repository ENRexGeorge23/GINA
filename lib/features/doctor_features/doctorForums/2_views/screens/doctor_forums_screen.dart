...
import 'package:first_app/features/doctor_features/doctorForums/2_views/screens/view_states/forums_details_post_state.dart';
import 'package:first_app/features/doctor_features/doctorForums/2_views/screens/view_states/forums_screen_loaded.dart';
import 'package:first_app/features/doctor_features/doctorForums/2_views/screens/view_states/reply_post_screen_state.dart';
          ...
          body: BlocConsumer<DoctorForumsBloc, DoctorForumsState>(
            ...
            listener: (context, state) {
              if (state is NavigateToDoctorForumsCreatePostState) {
                ...
                Navigator.pushNamed(context, '/forumsReplyPost').then((value) =>
                    forumsBloc.add(DoctorForumsFetchRequestedEvent()));
            ...
            builder: (context, state) {
              ...
              } else if (state is GetDoctorForumsPostEmpytState) {
                return const Center(
