...
import 'package:first_app/features/patient_features/periodTracker/2_views/screens/view_states/period_tracker_edit_dates_screen.dart';
import 'package:first_app/features/patient_features/periodTracker/2_views/screens/view_states/period_tracker_initial_screen.dart';
...
class PeriodTrackerScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: GinaPatientAppBar(title: 'Period Tracker'),
